        ...
        <>
            ...
            <div className="bg-primary sm:flex flex-row justify-between w-full py-2 px-7 hidden">
                ...
                <div className="flex flex-row items-center gap-x-2.5">
                    ...
                    <button className=" rounded-[32px] bg-[#CFA266] w-[137px] font-poppins text-[16px] font-normal text-white py-[10px] px-[16px] cursor-pointer" onClick={toggle} >Get in Touch</button>
                </div>
            </div>
