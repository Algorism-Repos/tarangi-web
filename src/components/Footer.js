    ...
    return (
        <>
            ...
            <div className="coming-soon">
                ...
                <button className="font-poppins text-white text-[24px] font-extralight leading-normal bg-[#4B001A] rounded-[93px] py-[20px] px-[26px] cursor-pointer mt-7 sm:mt-20 " onClick={toggle}
>Get in Touch</button>
            </div>
                ...
                <div className="flex flex-col gap-y-20 sm:flex-row sm:items-center sm:justify-between px-3 pt-5 pb-12 sm:py-0 sm:pt-0 sm:px-[70px] ">
                    <div className="">
                        ...
                        <div className=" flex flex-row items-center gap-x-6 w-fit ml-10 sm:ml-14">
                            ...
                            <a href="https://www.linkedin.com" target="_blank"><img src={whatsapp} className="w-[40px] h-[40px]" /></a>
                        </div>
                    </div>
