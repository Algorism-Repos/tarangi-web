      ...
      <div className="font-poppins bg-light-sandal py-[70px]">
        <div className="max-w-[1300px] mx-auto">
          ...
          <Link
            ...
            className="flex items-center gap-x-[6px] px-5"
          >
            <img
              className="w-[36px] rotate-90"
              src={red_arrow}
              alt="Arrow icon"
            />
            ...
            {cartItems.map((item, index) => (
              <div className="w-[694px] mx-auto xl:mx-0">
                ...
                <div className="bg-[#FFFAF3] max-w-[694px] p-[24px] rounded-[16px] shadow-2xl">
                  <img
                    className="float-right w-[29px] h-[29px] cursor-pointer"
                    src={close_icon}
                    alt="close icon"
                  ...
                  <div className="flex gap-x-[15px] sm:gap-x-[50px] items-center">
                    {/* product Image */}
                    <img
                      className="w-[110px] sm:w-[233px] sm:h-[239px]"
                      src={item.image}
                      alt="product image"
                    />
                    ...
                    <div className="space-y-[14px]">
                      ...
                      <div>
                        <h3 className="text-[14px] text-[#6F6F6F] sm:text-[14px]">
                          Color choosen
                        </h3>
                        <h3 className="text-[16px] font-medium sm:text-[18px]">
                          Gold
                        </h3>
                      </div>
                      ...
                      <h3 className="text-[14px] text-primary sm:text-[16px]">
                        Delivered by Oct 10
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="sm:flex items-center gap-x-[20px]">
                    <img
                      className="w-[74px] h-[74px] rounded-[16px]"
                      src={product_1}
                      alt="product image"
                    />
                    ...
                    <div className="flex items-center justify-between w-full">
                      ...
                      <p className="bg-[#C5A881] px-5 py-1.5 rounded-full text-[#404040]">
                        Free
                      </p>
                    </div>
                  </div>
            ...
            <div className="w-[466px] mx-auto xl:mx-0">
              ...
              <div className="bg-[#FFFAF3] max-w-[694px] p-[24px] rounded-[16px] shadow-2xl mt-[25px]">
                ...
                <div className="space-y-[16px]">
                  ...
                  <Link to="/checkout">
                    <button
                      className="bg-[#4B001A] text-white w-full h-[51px] rounded-full"
                    >
                      Place Order
                    </button>{" "}
                  </Link>
            ...
            <div className="sm:w-[694px] mx-auto xl:mx-0">
              <div className="bg-[#FFFAF3] max-w-[694px] p-[24px] rounded-[16px] shadow-2xl mt-[25px]">
                <div className="flex gap-x-[15px] sm:gap-x-[50px] items-center justify-between">
                  ...
                  <div className="space-y-[14px]">
                    <img
                      className="w-[150px] sm:w-[233px] sm:h-[239px]"
                      src={product_1}
                      alt="product image"
                    />
                ...
                <div className="mt-[24px]">
                  <h3 className="text-[14px] font-medium text-[#6F6F6F] sm:text-[18px]">
                    Total price
                  </h3>
                  <h3 className="text-[16px] font-semibold sm:text-[20px] mt-1">
                    ₹ 12,000
                  </h3>
                  <button className="bg-[#4B001A] w-full h-[51px] rounded-full text-white mt-[24px]">
                    Add to cart
                  </button>
                </div>
              </div>
