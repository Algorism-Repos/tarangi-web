            ...
            <div className="bg-light-sandal font-poppins py-[30px] sm:py-[70px]">
                ...
                <div className="max-w-[1300px] mx-auto px-5 sm:px-0">
                    ...
                    <div className="flex items-center justify-center gap-x-[8px] text-[#6F6F6F] text-[16px] xl:justify-start">
                        <p>Necklace</p>
                        <img className="w-[30px] h-[30px]" src={grey_arrow} alt="Arrow Icon" />
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-12 my-[20px] sm:my-[40px] xl:my-[70px]">
                        ...
                        <div className="lg:max-w-[640px] mx-auto">
                            ...
                            {/* Description */}
                            <div>
                                <h3 className="text-[#6F6F6F] text-[14px] font-medium">Description</h3>
                                <p className="text-[#484848] text-[16px] font-medium ">Handcrafted 22KT gold chain with a timeless design perfect for daily wear and gifting.</p>
                            </div>
                            ...
                            <div className="space-y-6 sm:space-y-3">
                                <h3 className="text-[#6F6F6F] text-[14px] font-medium">Check estimated delivery date with Pincode</h3>

                                <PincodeInput />

                                <div className="flex items-center gap-x-[8px]">
                                    <img className="w-[18px] h-[22px]" src={shopping_bag} alt="Shopping bag icon" />
                                    <h3 className="text-[#6F6F6F] text-[14px] font-medium ">Expected Delivery Date</h3>
                                </div>
                                <p className="text-[#484848] text-[15px] font-medium ">Delivered by Oct 10</p>
                            ...
                            <div className="">
                                ...
                                <div className="mt-2 flex justify-start gap-x-3">
                                    <img className="w-[45px] bg-white rounded-full border-primary hover:border-2 hover:p-[2px]" src={gold_ellipse} alt="gold ellipse" />
                                    <img className="w-[45px] bg-white rounded-full border-primary hover:border-2 hover:p-[2px]" src={silver_ellipse} alt="Silver ellipse" />
                                    <img className="w-[45px] bg-white rounded-full border-primary hover:border-2 hover:p-[2px]" src={brown_ellipse} alt="brown ellipse" />
                                </div>
                            </div>
                ...
                <div className='max-w-[1300px] mx-auto my-[60px] lg:my-[130px] px-4 sm:px-0'>
                    ...
                    {/* Look Like */}
                    <div>
                        <h1 className="font-atteron text-primary text-[26px] text-center sm:text-[30px] xl:text-left">you may also like</h1>
