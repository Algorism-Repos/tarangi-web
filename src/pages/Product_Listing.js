        ...
        {productCatergory.map((item) => {
          ...
          return (
            <Link
              ...
              state={{ product: item }}
              className="font-poppins w-[170px] sm:w-[310px] mx-auto relative hover:scale-105 transition duration-300 ease-in-out "
            >
              <img
                className={`w-[173px] h-[174px] sm:w-[304px] sm:h-[307px] rounded-[16px] ${
