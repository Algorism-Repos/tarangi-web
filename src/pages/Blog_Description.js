    ...
    <>
      ...
      <div className="bg-light-sandal font-poppins px-5 py-[50px] sm:py-[150px]">
        ...
        <div className="text-center">
          ...
          <p className="text-[#6E6E6E] mt-1">{blog.createdAt}</p>
        </div>
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="max-w-[1286px] text-[#595959] space-y-[40px] mx-auto ">
            {/* {blog?.map((item) => { 
                                        const content = parseArticleBody(item.body); */}
          ...
          <div>
            ...
            {faqData.map((item, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`px-4 py-3 mb-5 rounded-[8px] border-[1px] border-[#F3E4D1] transition-colors duration-300 ${
