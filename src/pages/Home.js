    ...
    <>
        ...
        <div className="max-w-7xl mx-auto py-20 sm:py-40 px-3 sm:px-0">
          ...
          <div className="hidden sm:flex flex-col sm:flex-row items-center sm:gap-x-12 gap-y-24 sm:flex-wrap justify-center mt-10 sm:mt-44">
            {specials.map((item, index) => (
              <div
                key={index}
                className="flex flex-col items-center transform transition-transform duration-300 ease-out hover:scale-110 cursor-pointer" data-aos="fade-up"
                onClick={() => {
      ...
      <div className="before-after-section">
        <div className="max-w-7xl mx-auto py-0 sm:py-10 px-3 sm:px-0">
          <h1 className="font-atteron section-heading text-[26px]  sm:text-[64px] text-center text-[#5C0A1F] mb-[80px]" data-aos="fade-up">
