        ...
        <>
            <div className="bg-light-sandal py-[70px]">
                <div className="max-w-[1300px] mx-auto">
                    <h1 className="font-atteron text-primary text-[26px] text-center sm:text-[30px] xl:text-left">Your Favourites</h1>
                    {/* Favourites*/}
                    <div>
                                ...
                                Products.map((item) => {
                                    return (
                                        <div className="relative font-poppins w-[170px] sm:w-[300px] mx-auto lg:mx-0">
                                            ...
                                            <img className="w-[40px] h-[40px] absolute right-3 top-3" src={Filled_LikeIcon} alt="Icon" />
                                            ...
                                            <div className="mt-2 sm:mt-4">
                                                ...
                                                <button className="flex items-center justify-center gap-x-[8px] border-2 border-[#4B001A] w-full h-[50px] rounded-full text-primary text-[16px] font-medium mt-2 sm:text-[18px] sm:h-[54px]">
                                                    <img className="w-[32px] h-[32px]" src={shoppingCart_red} alt="like_icon" />
                                                    Add to cart
                                                </button>
